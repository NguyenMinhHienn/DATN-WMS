...
const StaffReceivables: React.FC = () => {
    ...
    const loadData = async () => {
        setLoading(true);
        try {
            const listData = await receivableService.getAll({ 
                page, 
                limit: 10, 
                status: filterStatus,
    ...
    return (
        <div className="animate-fadeIn">
                ...
                <div className="p-4 border-b border-slate-100 flex flex-wrap gap-4 items-center justify-between bg-slate-50/50">
                    <div className="flex flex-wrap gap-3 flex-1">
                        ...
                        >
                            ...
                            <option value="has_pending">⏳ Có phiếu chờ duyệt</option>
            ...
            {/* Detail Modal */}
            {/* ==================== DETAIL MODAL ==================== */}
            <Modal isOpen={isDetailModalOpen} onClose={() => setIsDetailModalOpen(false)} title="📋 Chi tiết Công nợ (Phát sinh)" size="2xl">
                {detailData && (
                 ...
                 <form onSubmit={handleCreateReceipt} className="space-y-4">
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mt-4">
                        <p className="font-bold text-amber-800 text-sm flex items-center gap-1">
                            ⚠️ Lưu ý về quy trình duyệt phiếu
                        </p>
                        <ul className="text-xs text-amber-700 mt-2 space-y-1 ml-4 list-disc">
                            <li>Phiếu thu sẽ được gửi lên Admin duyệt.</li>
                            <li>Công nợ chỉ được khấu trừ sau khi Admin xác nhận.</li>
                        </ul>
...
export default StaffReceivables;
