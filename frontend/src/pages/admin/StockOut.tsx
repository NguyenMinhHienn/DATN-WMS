        ...
        <div className="animate-fadeIn p-6">
            <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p className="text-slate-600">Lịch sử và trạng thái các phiếu xuất hàng từ kho</p>
                </div>
            </div>
                        ...
                        <table className="w-full">
                            <thead className="bg-slate-50">
                                <tr>
                                    ...
                                    <th className="text-left py-3 px-4 text-sm font-medium text-slate-600">Kho xuất</th>
                            ...
                            <tbody>
                                ...
                                {transfers.length === 0 && (
                                    <tr><td colSpan={8} className="py-12 text-center text-slate-500">Không tìm thấy phiếu xuất kho</td></tr>
                                )}
                            </tbody>
                        </table>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg w-full max-w-3xl max-h-[90vh] overflow-y-auto p-6 m-4">
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <h2 className="text-xl font-bold">📤 Chi tiết phiếu xuất: {selectedTransfer.transfer_number}</h2>
