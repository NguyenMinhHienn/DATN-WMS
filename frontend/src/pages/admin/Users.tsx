        ...
        <div className="animate-fadeIn">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <div>
                    ...
                    <p className="text-slate-400 mt-1">Quản lý tài khoản và phân quyền hệ thống</p>
                </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead className="bg-slate-800/50 border-b border-slate-700/50">
                                <tr>
                                    <th className="text-left py-4 px-6 text-sm font-medium text-slate-300">Người dùng</th>
                                    <th className="text-left py-4 px-6 text-sm font-medium text-slate-300">Email</th>
                                    <th className="text-left py-4 px-6 text-sm font-medium text-slate-300">Vai trò</th>
                                    ...
                                    <tr key={user.id} className="border-b border-slate-700/30 hover:bg-slate-700/30 transition-colors">
                                        <td className="py-4 px-6">
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center text-white font-medium shadow-lg shadow-indigo-500/20">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {roles.map(role => (
                                    <label key={role.id} className="flex items-center gap-2 px-3 py-2 bg-slate-700/50 border border-slate-600/50 rounded-lg cursor-pointer hover:bg-slate-600/50 transition-colors">
                                        <input
                                            type="checkbox"
